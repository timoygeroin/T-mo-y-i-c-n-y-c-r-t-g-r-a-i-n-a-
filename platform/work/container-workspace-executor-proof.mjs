...
try {
  ...
  if (compute.status !== "completed") console.error("WORKUP_CONTAINER_DEBUG", JSON.stringify(compute, null, 2));
  ...
  if (write.status !== "completed") console.error("WORKUP_CONTAINER_WRITE_DEBUG", JSON.stringify(write, null, 2));
  ...
  if (network.status !== "completed") console.error("WORKUP_CONTAINER_NETWORK_DEBUG", JSON.stringify(network, null, 2));
  ...
  if (rootWrite.status !== "completed") console.error("WORKUP_CONTAINER_ROOT_DEBUG", JSON.stringify(rootWrite, null, 2));
  ...
  if (timeout.status !== "timeout") console.error("WORKUP_CONTAINER_TIMEOUT_DEBUG", JSON.stringify(timeout, null, 2));
