...
test("accepts an external embodiment packet without a status claim", () => {
...
test("blocks a receipt whose class does not match the packet", () => {
...
test("accepts a fresh status packet when status is bound to the packet head", () => {
