...
recent_anchor = '                Section("Recent changes") {'
semantic_sections = '''                Section("Changed") {
...
'''
assert recent_anchor in text, 'recent changes anchor drifted'
text = text.replace(recent_anchor, semantic_sections + recent_anchor, 1)
